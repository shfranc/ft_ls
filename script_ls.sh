...
clang -Wall -Werror -Wextra -fsanitize=address -o ft_ls ../libft_gitperso/libft.a -I ../libft_gitperso/includes -I includes srcs/main.c srcs/parsing_options.c srcs/display.c srcs/parsing_names.c srcs/classic_display.c
